...
private static SessionFactory sf=null;
	...
	@Test
	public void one2oneUniFkAnnotionTest(){
		...
		Husband h2 = (Husband)session2.load(Husband.class, 3);
		
		System.out.println(h2.getWife().getName());
	...
	@Test
	public void one2oneUniFkXmlTest(){
